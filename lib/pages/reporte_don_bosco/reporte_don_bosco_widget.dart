...
import 'reporte_don_bosco_model.dart';
export 'reporte_don_bosco_model.dart';

class ReporteDonBoscoWidget extends StatefulWidget {
  const ReporteDonBoscoWidget({Key? key}) : super(key: key);

  @override
  _ReporteDonBoscoWidgetState createState() => _ReporteDonBoscoWidgetState();
}

class _ReporteDonBoscoWidgetState extends State<ReporteDonBoscoWidget> {
  late ReporteDonBoscoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteDonBoscoModel());
  }
