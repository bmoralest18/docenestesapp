...
import 'reporte_sentimientos_model.dart';
export 'reporte_sentimientos_model.dart';

class ReporteSentimientosWidget extends StatefulWidget {
  const ReporteSentimientosWidget({
    Key? key,
    this.idTeacher,
    this.nameDocente,
    this.idUser,
  ...
  @override
  _ReporteSentimientosWidgetState createState() =>
      _ReporteSentimientosWidgetState();
}

class _ReporteSentimientosWidgetState extends State<ReporteSentimientosWidget> {
  late ReporteSentimientosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteSentimientosModel());
  }
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    'Dinamicó: ${valueOrDefault<String>(
                                                      listViewFeelingRow
                                                          .dinamico
                                                          ?.toString(),
                                                      '0',
