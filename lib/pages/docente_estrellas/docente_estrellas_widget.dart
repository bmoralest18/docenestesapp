...
import 'docente_estrellas_model.dart';
export 'docente_estrellas_model.dart';

class DocenteEstrellasWidget extends StatefulWidget {
  const DocenteEstrellasWidget({
    Key? key,
    this.idTeacher,
    this.nameDocente,
    this.idUser,
  ...
  @override
  _DocenteEstrellasWidgetState createState() => _DocenteEstrellasWidgetState();
}

class _DocenteEstrellasWidgetState extends State<DocenteEstrellasWidget> {
  late DocenteEstrellasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocenteEstrellasModel());
  }
                              ...
                              children: [
                                FutureBuilder<ApiCallResponse>(
                                  future: GetTeacherByIdCall.call(
                                    idUsera: widget.idTeacher?.toString(),
                                  ),
