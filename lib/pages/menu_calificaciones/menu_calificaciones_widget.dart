...
import 'menu_calificaciones_model.dart';
export 'menu_calificaciones_model.dart';

class MenuCalificacionesWidget extends StatefulWidget {
  const MenuCalificacionesWidget({
    Key? key,
    this.idSubject,
    this.idUser,
    this.email,
  ...
  @override
  _MenuCalificacionesWidgetState createState() =>
      _MenuCalificacionesWidgetState();
}

class _MenuCalificacionesWidgetState extends State<MenuCalificacionesWidget> {
  late MenuCalificacionesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenuCalificacionesModel());
  }
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 4.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Califica la pasión de enseñanza del docente.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodySmall
                                                        .override(
