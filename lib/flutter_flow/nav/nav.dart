        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'envioCorreo',
              path: 'envioCorreo',
              builder: (context, params) => EnvioCorreoWidget(),
            ),
            FFRoute(
              name: 'cambio',
              path: 'cambio',
              builder: (context, params) => CambioWidget(),
            ),
            FFRoute(
              name: 'contraseaCambio',
              path: 'contraseaCambio',
              builder: (context, params) => ContraseaCambioWidget(),
            )
