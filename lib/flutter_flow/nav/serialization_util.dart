    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case ClassRow:
            return ClassRow(data);
          case ScoreStarsRow:
            return ScoreStarsRow(data);
          case AvatarRow:
            return AvatarRow(data);
          case TeacherRow:
            return TeacherRow(data);
          case StudentRow:
            return StudentRow(data);
          case AdministratorRow:
            return AdministratorRow(data);
          case FeelingRow:
            return FeelingRow(data);
          case ScoreFeelingRow:
            return ScoreFeelingRow(data);
          case ReviewRow:
            return ReviewRow(data);
          case DonBoscoRow:
            return DonBoscoRow(data);
          case RankingRow:
