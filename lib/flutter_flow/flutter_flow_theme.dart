...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFD183756);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF50576E);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFFA6AAAD);
  late Color secondaryText = const Color(0xCFBCC1D1);
  late Color primaryBackground = const Color(0xF84C4C46);
  late Color secondaryBackground = const Color(0xFC252322);
  ...
  late Color warning = const Color(0xFFFCDC0C);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFFFFFCFC);

  late Color primaryBtnText = Color(0xFFFFFCFC);
  late Color lineColor = Color(0xCF888D9B);
  late Color grayIcon = Color(0xFFB8CFE2);
  late Color gray200 = Color(0xFFDBE2E7);
  late Color gray600 = Color(0xFF262D34);
  late Color black600 = Color(0xFF090F13);
  late Color tertiary400 = Color(0xFF39D2C0);
  late Color textColor = Color(0xFF1E2429);
  late Color btnText = Color(0xFF898B8F);
  late Color customColor3 = Color(0xFFDF3F3F);
  late Color customColor4 = Color(0xFF071F68);
  late Color white = Color(0xFFFFFFFF);
  late Color background = Color(0xFF1D2429);
  late Color backgroundComponents = Color(0xFF1D2428);
  late Color primary600 = Color(0xFF336A4A);
